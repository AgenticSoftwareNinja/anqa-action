...
export interface ProjectConfig {
  ...
  pr_analysis?: { enabled: boolean; target_branches: string[]; skip_drafts: boolean; auto_commit_heals: boolean; min_tests_required: number } | null;
