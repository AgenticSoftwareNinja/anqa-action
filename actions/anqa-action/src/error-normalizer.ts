...
const ERROR_PATTERNS: Array<{
  ...
  {
    pattern:
      /locator\.\w+: Element is not (visible|attached|enabled)|locator\.\w+: No element/i,
    code: "element_not_found",
    guidance:
      "The test couldn't find a UI element. The page may have changed since the audit.",
  },
  {
    pattern: /net::ERR_CONNECTION_REFUSED|ECONNREFUSED|ENOTFOUND/i,
    code: "site_unreachable",
    guidance:
      "Could not reach your site. Check that the target URL is accessible.",
  },
  {
    pattern: /401 Unauthorized|403 Forbidden/i,
    code: "auth_failed",
    guidance:
      "Authentication failed. Check your auth configuration in project settings.",
  },
  {
  ...
  },
  {
    ...
    code: "llm_rate_limit",
    guidance:
      "Hit API rate limits. Try again in a few minutes or reduce max_flows.",
  },
  {
    pattern: /anthropic.*invalid_api_key|authentication_error/i,
    code: "llm_auth_failed",
    guidance:
      "Anthropic API key is invalid. Update ANTHROPIC_API_KEY in your GitHub repository secrets.",
  },
