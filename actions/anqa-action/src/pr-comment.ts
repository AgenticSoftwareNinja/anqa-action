// actions/anqa-action/src/pr-comment.ts
...
interface BuildPRCommentOptions {
  ...
  totalFlows: number;
  timingMs: { mapping: number; execution: number; healing: number };
...
export function buildPRComment(options: BuildPRCommentOptions): string {
...
export function buildDryRunComment(options: BuildDryRunOptions): string {
